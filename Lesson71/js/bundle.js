...
function carusel(){
    ...
    function deleleNotDigits(str) {
        return +str.replace(/\D/g, ' ');
    }

    next.addEventListener('click', () => {
        if (offset == deleleNotDigits(width) * (slides.length - 1)) {
            offset = 0;
        } else {
            offset += deleleNotDigits(width); 
        }
    ...
    prev.addEventListener('click', () => {
        if (offset == 0) {
            offset = deleleNotDigits(width) * (slides.length - 1);
        } else {
            offset -= deleleNotDigits(width);
        }
    ...
    dots.forEach(dot => {
        dot.addEventListener('click', (e) => {
            ...
            slideIndex = slideTo;
            offset = deleleNotDigits(width) * (slideTo - 1);
...
window.addEventListener('DOMContentLoaded', () => {
    const tabs = __webpack_require__(/*! ./modules/tabs */ "./js/modules/tabs.js"),
          ...
          carusel = __webpack_require__(/*! ./modules/carusel */ "./js/modules/carusel.js");
    tabs();
    modal();
    timer();
    cards();
