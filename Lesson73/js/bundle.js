...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function carusel({container, slide, nextArrow, prevArrow, totalCounter, currentCounter,wrapper, field}) {
    let offset = 0;
    let slideIndex = 1;
...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            // const obj = {a: 23, b:50}; //entries - преобразует объект в массив
...
// API - набор данных и возможностей, который предоставляет готовое решение
// DOM API 
...
/* harmony import */ var _modules_carusel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/carusel */ "./js/modules/carusel.js");
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_carusel__WEBPACK_IMPORTED_MODULE_6__["default"])({
